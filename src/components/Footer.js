  ...
  return (
    <footer className="border-t border-neutral-200 mt-16 px-5 md:px-16 py-10 md:py-16">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link href={"/"} className="text-3xl">
              <span className="text-rose-600">S</span>erviceSprint Hub
            </Link>
            <p className="max-w-xs mt-4 text-sm">
              Building innovative software solutions. Delivering engineer-crafted products for your needs.
            </p>
            <div className="flex mt-8 space-x-6">
              <Link
                href="https://www.facebook.com/profile.php?id=100094236237884&mibextid=ZbWKwL"
                target="_blank"
              >
                <FacebookOutlinedIcon className="hover:text-rose-600 hover:-translate-y-1 transition-all" />
              </Link>
              <Link href="https://github.com/Kandulanaveennaidu" target="_blank">
                <GitHubIcon className="hover:text-rose-600 hover:-translate-y-1 transition-all" />
              </Link>
              <Link
                href="https://www.linkedin.com/in/kandula-naveen-69251720b/"
                target="_blank"
              >
              ...
              <Link
                href="https://www.instagram.com/naveennaidu017/"
                target="_blank"
              >
        ...
        <p className="mt-8 text-xs">© Software Engineer Products Delivered - © 2023 ServiceSprint Hub. All rights reserved.</p>
      </div>
    </footer>
  );
};
