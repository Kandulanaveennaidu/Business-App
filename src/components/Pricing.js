  ...
  return (
    <div className="mx-2 md:mx-3 cursor-pointer p-10 transition-all hover:shadow-lg flex flex-col gap-12 rounded-3xl border-neutral-200 border">
      ...
      <div className="flex flex-col gap-5">
        <Plan title="Professional Design Services" />
        <Plan title="Customizable Templates" />
        <Plan title="Advanced Blogging Tools" />
        <Plan title="E-commerce Solutions" />
      </div>
...
const Pricing = () => {
  ...
  return (
    ...
    >
      <div>
        <span className="service-name text-center ">PRICING PLANS</span>
        <h2 className="title text-center ">Select the right plan for your professional needs</h2>
      </div>
      ...
      {plan === "Monthly Plan" ? (
        <Carousel {...carouselParams}>
          <PricingCard
            ...
            title="Tailored for Small to Medium Enterprises"
            price="25000"
            btnText="Start Free Trial"
          />
          <PricingCard
            name="Corporate Business"
            title="Perfect for Large Enterprises"
            price="40000"
          ...
          <div className="relative">
            ...
            <PricingCard
              name="Pro Developer"
              title="Ideal for Advanced Development"
              price="45000"
              btnText="Create an Account"
              trail="Or Start 14 Days Trial"
            />
